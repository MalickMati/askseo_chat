<div class="menu" id="sidebarMenu">
    @if (session()->has('super_admin_loged'))
        <div class="menu-item" onclick="window.location.href='/admin';">
            <svg width="20" height="20" fill="#54656F" viewBox="0 0 16 16"  ><path fill-rule="evenodd" d="M10.025 9.975 5.83 14.17a2.828 2.828 0 1 1-4-4l4.195-4.195a4.5 4.5 0 0 1 6.405-4.542l-2.145 2.145a1.5 1.5 0 1 0 2.121 2.121l2.15-2.15a4.5 4.5 0 0 1 .421 2.408 4.5 4.5 0 0 1-4.952 4.018m-.74-2.088-4.87 4.869a.828.828 0 0 1-1.17-1.172l4.868-4.869z"/></svg>
    ...
    @if (session('user_type') === 'admin' || session('user_type') === 'moderator' || session('user_type') === 'super_admin')
        <div class="menu-item" onclick="window.location.href='/add/group';">
            <svg width="20" height="20" viewBox="0 0 36 36" fill="#54656F"><path class="clr-i-solid clr-i-solid-path-1" d="M12 16.14h-.87a8.67 8.67 0 0 0-6.43 2.52l-.24.28v8.28h4.08v-4.7l.55-.62.25-.29a11 11 0 0 1 4.71-2.86A6.6 6.6 0 0 1 12 16.14"/><path class="clr-i-solid clr-i-solid-path-2" d="M31.34 18.63a8.67 8.67 0 0 0-6.43-2.52 11 11 0 0 0-1.09.06 6.6 6.6 0 0 1-2 2.45 10.9 10.9 0 0 1 5 3l.25.28.54.62v4.71h3.94v-8.32Z"/><path class="clr-i-solid clr-i-solid-path-3" d="M11.1 14.19h.31a6.45 6.45 0 0 1 3.11-6.29 4.09 4.09 0 1 0-3.42 6.33Z"/><path class="clr-i-solid clr-i-solid-path-4" d="M24.43 13.44a7 7 0 0 1 0 .69 4 4 0 0 0 .58.05h.19A4.09 4.09 0 1 0 21.47 8a6.53 6.53 0 0 1 2.96 5.44"/><circle class="clr-i-solid clr-i-solid-path-5" cx="17.87" cy="13.45" r="4.47"/><path class="clr-i-solid clr-i-solid-path-6" d="M18.11 20.3A9.7 9.7 0 0 0 11 23l-.25.28v6.33a1.57 1.57 0 0 0 1.6 1.54h11.49a1.57 1.57 0 0 0 1.6-1.54V23.3l-.24-.3a9.58 9.58 0 0 0-7.09-2.7"/><path fill="none" d="M0 0h36v36H0z"/></svg>
            <span>Add Group</span>
        </div>
    @endif
